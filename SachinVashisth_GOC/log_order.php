	...
	header('location:customer.php');
		...
		if ($_SERVER["REQUEST_METHOD"] == "POST"){
			if(isset($_POST['orderBtn']) &&isset($_POST['total_price']) && isset($_POST['address']) && isset($_POST['mobile_number']) && isset($_POST['res_id'])){
		        ...
		        $res_id = $_POST['res_id'];
		        $sql="INSERT INTO orders(user_id, vendor_id, address, date, mode_of_payment, total, mobile) values ('$user_id', '$res_id', '$address', '$date', '$payment_type', '$total_price', '$mobile_number')";
