...
<html>
<head>
	<title>आत्मनिर्भर भारत | Home</title>
...
<body>
	...
	<nav class="navbar navbar-custom navbar-expand-md  navbar-dark">
		...
		<div class="collapse navbar-collapse justify-content-end" id="collapsibleNavbar">
			<ul class="navbar-nav">
				<li class="nav-item">
					<a class="nav-link" href="#menu"><span style="color:white">Catalogue</span></a>
				</li>
				<li class="nav-item">
	...
	<div class="container">
		<div class="cursive mainheader">
			<span class="align-middle" style="font-size:40px; letter-spacing: 3px">Vocal</span>
			<span class="align-middle" style="font-size:30px; letter-spacing: 3px">For</span>
			<span class="align-middle" style="color:#FF5733">Local</span><br>
		</div>
	</div>
	<br><br>
		<?php 
	    	require 'connect.php';
	    	$sql = "select catalog.*, vendor.vendor_name from catalog, vendor where catalog.vendor_id=vendor.id";
					...
					while($row = $result->fetch_assoc()){ ?>
						<div class="card menu-card" style="width: 22rem;">
							...
							<div class="card-body">
								...
								Vendor Name: <?php echo ucwords($row['vendor_name']) ?>
								<form class="cart-form" action="add_cart.php" method="post">
										<input type="hidden" name="item_id" value="<?php echo $row['item_id']; ?>">
										<input type="hidden" name="res_id" value="<?php echo $row['vendor_id']; ?>">
