...
<html>
<head>
	<title>आत्मनिर्भर भारत | Vendor</title>
...
<body>
	...
	<nav class="navbar navbar-custom navbar-expand-md  navbar-dark">
		...
		<div class="collapse navbar-collapse justify-content-end" id="collapsibleNavbar">
			<ul class="navbar-nav">
				...
				?>
				<li class="nav-item">
					<a class="nav-link active" href="#"><span style="color:white; font-size:20px">Welcome, <?php echo $row['vendor_name'] ?></span></a>
				</li>   
				<li class="nav-item">
					<button type="button" class="btn btn-warning" onclick="location.href='vendor_dashboard.php'">
						Dashboard
					</button>  
				</li>  
				<li class="nav-item">
	...
	<?php 
			$i = $_SESSION['restid'] ;
	    	$sql = "select catalog.*, vendor.vendor_name from catalog, vendor where catalog.vendor_id=vendor.id and vendor.id = $i";
	    	$result = $conn->query($sql);
	?>
